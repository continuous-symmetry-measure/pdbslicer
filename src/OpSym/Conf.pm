...
use strict;
use warnings;
use vars qw/$src_dir $logs_dir/;

our $base_dir='/opt/PKG/Chem/mysym/perl_scripts/2.0';
our $src_dir	="$base_dir/src";
#our $logs_dir="$base_dir/logs";
our $logs_dir=".";
...
#------------------------------------------
# when this is tru the Energy_reported will
# be  subtracted from the energy value.
our $Energy_reported_flag=1;

#our $Csm_dir='/home/shared/mysym/devel/new_CSM.2009.12.09/bin';
#our $Csm_dir='/home/shared/mysym/devel/CSM/new_CSM.2010.05.05/bin';
our $Printf_Number_Precision= '%3.6f';
our $Csm_dir                = $ENV{CSM_DIR};
our $Shape_dir              = '/homes/shared/mysym/PROGRAMS/Avnir-shape/bin/';
